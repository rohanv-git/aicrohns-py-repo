"""
P2_colon: Population-Level Drug2Cell Analysis - COLON
...
CHECKPOINT_DIR = 'checkpoints/colon'
...
print("=" * 80)
print("P2_colon: POPULATION-LEVEL DRUG2CELL ANALYSIS - COLON")
print("WITH HEALTHY CONTROLS + MSigDB PATHWAYS + VISUALIZATIONS")
print("=" * 80)
...
# ============================================================================
print("[1/7] Loading and filtering colon data...")
...
if os.path.exists(checkpoint_path):
    ...
    print(f"      After tissue filtering (colon): {adata.n_obs} cells")
...
plt.tight_layout()
plt.savefig(FIG_DIR / f"Step1_DataFiltering_{TISSUE.replace(' ', '')}.png", dpi=300, bbox_inches='tight')
plt.close()
...
axes[1, 1].axis('off')
table = axes[1, 1].table(cellText=summary_data, cellLoc='left', loc='center', bbox=[0, 0, 1, 1])
...
plt.tight_layout()
plt.savefig(FIG_DIR / f'Step4_GeneRanking_{TISSUE.replace(" ", "")}.png', dpi=300, bbox_inches='tight')
plt.close()
print("  ✓ Saved: Step4_GeneRanking.png")

# ============================================================================
# STEP 5: Hypergeometric tests
# ============================================================================
...
# ============================================================================
print("[6/7] Running GSEA (20-45 minutes with 2186 pathways)...")
...
if len(gsea_df) > 0:
    ...
    plt.savefig(FIG_DIR / f'Step6_GSEA_Overview_{TISSUE.replace(" ", "")}.png', dpi=300, bbox_inches='tight')
    plt.close()
...
if len(gsea_filtered) > 0:
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / f'Step7_Filtered_Results_{TISSUE.replace(" ", "")}.png', dpi=300, bbox_inches='tight')
    plt.close()
...
# ============================================================================
print("=" * 80)
print("P2_colon COMPLETE - SUMMARY")
print("=" * 80)
