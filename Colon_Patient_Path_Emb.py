"""
P3_colon: Pathway Embeddings via SVD - COLON
WITH INTEGRATED VISUALIZATIONS
"""
import numpy as np
import pandas as pd
import pickle
...
print("="*80)
print("P3_colon: PATHWAY EMBEDDINGS VIA SVD - COLON")
print("WITH INTEGRATED VISUALIZATIONS")
print("="*80)
...
plt.suptitle('P3 Input Data from P2 - Colon', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig(FIG_DIR / "Step1_Input_Data_Colon.png", dpi=300, bbox_inches='tight')
plt.close()
print("  ✓ Saved: Step1_Input_Data_Colon.png")
...
plt.suptitle('P3 Pathway Filtering - Colon', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig(FIG_DIR / "Step2_Pathway_Filtering_Colon.png", dpi=300, bbox_inches='tight')
plt.close()
print("  ✓ Saved: Step2_Pathway_Filtering_Colon.png")
...
plt.suptitle('P3 Pathway Embedding Analysis - Colon', fontsize=16, fontweight='bold')
plt.savefig(FIG_DIR / 'Step3_Embedding_Analysis_Colon.png', dpi=300, bbox_inches='tight')
plt.close()
print("  ✓ Saved: Step3_Embedding_Analysis_Colon.png")
...
output_data = {
    ...
    'crohns_embeddings': crohns_embeddings,
    'pathway_lookup': filtered_pathway_lookup,
    'pathway_order': significant_pathways,
...
plt.suptitle('P3 Final Summary - Colon', fontsize=14, fontweight='bold')
plt.tight_layout()
plt.savefig(FIG_DIR / 'Step4_Final_Summary_Colon.png', dpi=300, bbox_inches='tight')
plt.close()
print("  ✓ Saved: Step4_Final_Summary_Colon.png")

print("\n" + "="*80)
print("P3_colon COMPLETE - SUMMARY")
print("="*80)
