# P2_colon.py - Population-Level Drug2Cell Analysis for COLON ONLY
...
def main():
    print("="*80)
    print("P2: POPULATION-LEVEL DRUG2CELL ANALYSIS - COLON")
    print("="*80)
    ...
    # Colon checkpoints
    checkpoint_filtered = "checkpoints/colon/P2_filtered_data.h5ad"
    checkpoint_drug2cell = "checkpoints/colon/P2_drug2cell_scored.h5ad"
    checkpoint_ranked = "checkpoints/colon/P2_ranked.h5ad"
    checkpoint_gsea = "checkpoints/colon/P2_gsea_results.csv"
    checkpoint_gsea_filtered = "checkpoints/colon/P2_gsea_results_BIG_DARK_ONLY.csv"
    checkpoint_hyper = "checkpoints/colon/P2_hypergeometric_results.csv"
    checkpoint_hyper_filtered = "checkpoints/colon/P2_hypergeometric_results_BIG_DARK_ONLY.csv"
    ...
    if os.path.exists(checkpoint_filtered):
        ...
        print("\n[1/7] Loading and filtering colon data...")
        ...
        # Filter by COLON tissue (ONLY CHANGE FROM SMALL INTESTINE)
        adata_tissue = adata_crohns[adata_crohns.obs['tissue'].isin(["colon"]), :].copy()
    ...
    # STEP 2: UMAP
    if not os.path.exists("figures/P2_figs/colon/umap_P2_cell_types.png"):
        print("\n[2/7] Generating UMAP...")
        sc.settings.set_figure_params(dpi=80)
        sc.pl.umap(adata, color="annotation2v2", save="_P2_cell_types_colon.png", show=False)
        # Move to correct location
        import shutil
        if os.path.exists("figures/umap_P2_cell_types_colon.png"):
            shutil.move("figures/umap_P2_cell_types_colon.png", "figures/P2_figs/colon/umap_P2_cell_types.png")
    else:
    ...
    if os.path.exists(checkpoint_gsea_filtered) and not needs_regeneration:
        ...
        # Load P2 data
        gsea = pd.read_csv(checkpoint_gsea_filtered)
        ...
        gsea_clean.to_csv(checkpoint_gsea_filtered, index=False)
