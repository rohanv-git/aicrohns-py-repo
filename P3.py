# P3.py - Create patient embeddings from P2 pathway data
...
# Setup
print("="*80)
print("P3: PATIENT PATHWAY PROFILE GENERATION")
print("="*80)
...
P2_H5AD_FILE = "checkpoints/P2_filtered_data.h5ad"

# File paths - OUTPUTS (P3 generates these)
OUTPUT_EMBEDDINGS = "results/P3_results/P3_patient_embeddings.csv"
OUTPUT_GENE_EMBEDDINGS = "results/P3_results/P3_gene_embeddings.csv"
OUTPUT_PATHWAY_SCORES = "results/P3_results/P3_pathway_scores.csv"

# Checkpoint files (intermediate)
CHECKPOINT_PATHWAY_GENES = "checkpoints/P3_pathway_genes.pkl"
CHECKPOINT_GENE_PATHWAY_MATRIX = "checkpoints/P3_gene_pathway_matrix.npz"
CHECKPOINT_COMMON_GENES = "checkpoints/P3_common_genes.pkl"

# Figure paths
FIG_PATIENT_CLUSTERING = "figures/P3_figs/P3_patient_clustering.png"
FIG_PATHWAY_HEATMAP = "figures/P3_figs/P3_pathway_heatmap.png"
FIG_EMBEDDING_DISTRIBUTION = "figures/P3_figs/P3_embedding_distribution.png"
FIG_GENE_EMBEDDING_PCA = "figures/P3_figs/P3_gene_embedding_pca.png"
...
# ============================================================================
# BONUS: Calculate pathway activity scores (WITH CHECKPOINT)
# ============================================================================
...
print("\nNext step: Run P4 to match patients to drugs!")
print("="*80)