# P4_colon.py - Match patients to drugs using Random Forest
...
P3_PATIENT_EMBEDDINGS = "results/P3_results/colon/P3_patient_embeddings.csv"
P3_GENE_EMBEDDINGS = "results/P3_results/colon/P3_gene_embeddings.csv"
P3_PATHWAY_SCORES = "results/P3_results/colon/P3_pathway_scores.csv"

# File paths - OUTPUTS
OUTPUT_PREDICTIONS = "results/P4_results/colon/P4_drug_predictions.csv"
OUTPUT_MODEL = "checkpoints/colon/P4_model.pkl"
OUTPUT_METRICS = "results/P4_results/colon/P4_model_metrics.json"
OUTPUT_FEATURE_IMPORTANCE = "results/P4_results/colon/P4_feature_importance.csv"

# Checkpoint files
CHECKPOINT_DRUG_EMBEDDINGS = "checkpoints/colon/P4_drug_embeddings.pkl"
CHECKPOINT_FEATURES = "checkpoints/colon/P4_features.pkl"
CHECKPOINT_TRAIN_TEST = "checkpoints/colon/P4_train_test_split.pkl"
CHECKPOINT_PREDICTIONS = "checkpoints/colon/P4_predictions.pkl"

# Figure paths
FIG_ROC_CURVE = "figures/P4_figs/colon/P4_roc_curve.png"
FIG_CONFUSION_MATRIX = "figures/P4_figs/colon/P4_confusion_matrix.png"
FIG_FEATURE_IMPORTANCE = "figures/P4_figs/colon/P4_feature_importance.png"
FIG_LEARNING_CURVE = "figures/P4_figs/colon/P4_learning_curve.png"
FIG_SHAP_SUMMARY = "figures/P4_figs/colon/P4_shap_summary.png"
FIG_PREDICTION_DIST = "figures/P4_figs/colon/P4_prediction_distribution.png"
